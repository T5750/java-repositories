...
public class JavaReadWriteJsonTest {
	@Rule
	...
	@Test
	public void writeJavaToJson() throws Exception {
	...
	@Test
	public void readJsonToJava() throws Exception {
		final ObjectMapper objectMapper = new ObjectMapper();
	...
	@Test
	public void readJsonToJsonNode() throws Exception {
		final ObjectMapper objectMapper = new ObjectMapper();
	...
	@Test
	public void readJsonToList() throws Exception {
		final ObjectMapper objectMapper = new ObjectMapper();
		final List<Car> listCar = objectMapper.readValue(LOCAL_JSON,
	...
	@Test
	public void readJsonToMap() throws Exception {
		final ObjectMapper objectMapper = new ObjectMapper();
		final Map<String, Object> map = objectMapper.readValue(EXAMPLE_JSON,
